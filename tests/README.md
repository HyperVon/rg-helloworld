...
| `end-to-end/` | `run_e2e.sh`: full milestone acceptance; later `rghw run` -> "HELLO WORLD" | 0 (gates), 9 (pipeline) |
| `chaos/` | Minimal chaos test (rasterizer pod kill) | 12 |
| `anti-cheating/` | Prohibited-field scans and printer enforcement (directory reserved; tests deferred) | 1+ |
